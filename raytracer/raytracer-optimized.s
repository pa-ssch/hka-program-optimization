...
0000000000000000 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f>:
  ...
  bool intersects(Vector<T, 3> origin, Vector<T, 3> direction,
   0:	55                   	push   %rbp
   1:	48 89 e5             	mov    %rsp,%rbp
   4:	48 81 ec 10 01 00 00 	sub    $0x110,%rsp
  ...
  26:	48 89 b5 10 ff ff ff 	mov    %rsi,-0xf0(%rbp)
  2d:	48 89 95 08 ff ff ff 	mov    %rdx,-0xf8(%rbp)
  34:	48 89 8d 00 ff ff ff 	mov    %rcx,-0x100(%rbp)
  3b:	c5 fa 11 a5 fc fe ff 	vmovss %xmm4,-0x104(%rbp)
  42:	ff 
  43:	48 89 85 28 ff ff ff 	mov    %rax,-0xd8(%rbp)
  4a:	8b 85 30 ff ff ff    	mov    -0xd0(%rbp),%eax
  50:	83 e0 00             	and    $0x0,%eax
  53:	44 09 c8             	or     %r9d,%eax
  56:	89 85 30 ff ff ff    	mov    %eax,-0xd0(%rbp)
  5c:	48 89 bd 18 ff ff ff 	mov    %rdi,-0xe8(%rbp)
  63:	8b 85 20 ff ff ff    	mov    -0xe0(%rbp),%eax
  69:	83 e0 00             	and    $0x0,%eax
  6c:	44 09 c0             	or     %r8d,%eax
  6f:	89 85 20 ff ff ff    	mov    %eax,-0xe0(%rbp)
  ...
  84:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
  8b:	48 8d 50 18          	lea    0x18(%rax),%rdx
  8f:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
  96:	48 8b 08             	mov    (%rax),%rcx
  99:	8b 40 08             	mov    0x8(%rax),%eax
  9c:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
  a3:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
  aa:	ff 
  ab:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
  b2:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
  b9:	ff 
  ...
  db:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
  e2:	48 8d 50 0c          	lea    0xc(%rax),%rdx
  e6:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
  ed:	48 8b 08             	mov    (%rax),%rcx
  f0:	8b 40 08             	mov    0x8(%rax),%eax
  f3:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
  fa:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 101:	ff 
 102:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 109:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 110:	ff 
 ...
 140:	48 89 b5 f0 fe ff ff 	mov    %rsi,-0x110(%rbp)
 147:	c5 fa 7e 95 f0 fe ff 	vmovq  -0x110(%rbp),%xmm2
 14e:	ff 
 14f:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 156:	c5 fa 7e 9d f0 fe ff 	vmovq  -0x110(%rbp),%xmm3
 15d:	ff 
 15e:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 165:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 16c:	ff 
 16d:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 174:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 17b:	ff 
 17c:	e8 00 00 00 00       	callq  181 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x181>
 181:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 186:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 18b:	48 89 85 5c ff ff ff 	mov    %rax,-0xa4(%rbp)
 192:	8b 85 64 ff ff ff    	mov    -0x9c(%rbp),%eax
 198:	83 e0 00             	and    $0x0,%eax
 19b:	09 d0                	or     %edx,%eax
 19d:	89 85 64 ff ff ff    	mov    %eax,-0x9c(%rbp)

    T normalRayProduct = normal.scalar_product(direction);
 1a3:	48 8b 8d 18 ff ff ff 	mov    -0xe8(%rbp),%rcx
 1aa:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 1b0:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 1b7:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 1be:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 1c5:	ff 
 1c6:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 1cd:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 1d4:	ff 
 ...
 1e1:	89 85 48 ff ff ff    	mov    %eax,-0xb8(%rbp)

    if (fabs(normalRayProduct) < EPSILON)
 1e7:	c5 fa 10 8d 48 ff ff 	vmovss -0xb8(%rbp),%xmm1
 1ee:	ff 
 1ef:	c5 fa 10 05 00 00 00 	vmovss 0x0(%rip),%xmm0        # 1f7 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x1f7>
 1f6:	00 
 1f7:	c5 f8 54 c1          	vandps %xmm1,%xmm0,%xmm0
 1fb:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
 1ff:	c5 fb 10 0d 00 00 00 	vmovsd 0x0(%rip),%xmm1        # 207 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x207>
 206:	00 
 207:	c5 f9 2e c8          	vucomisd %xmm0,%xmm1
 20b:	76 0a                	jbe    217 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x217>
    {
      return false;
 20d:	b8 00 00 00 00       	mov    $0x0,%eax
 212:	e9 6f 06 00 00       	jmpq   886 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x886>
    }

    T d = normal.scalar_product(p1);
 217:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 21e:	48 8b 08             	mov    (%rax),%rcx
 221:	8b 50 08             	mov    0x8(%rax),%edx
 224:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 22b:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 232:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 239:	ff 
 23a:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 241:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 248:	ff 
 249:	48 89 c7             	mov    %rax,%rdi
 24c:	e8 00 00 00 00       	callq  251 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x251>
 251:	c5 f9 7e c0          	vmovd  %xmm0,%eax
 255:	89 85 4c ff ff ff    	mov    %eax,-0xb4(%rbp)
    t = (d - normal.scalar_product(origin)) / normalRayProduct;
 25b:	48 8b 8d 28 ff ff ff 	mov    -0xd8(%rbp),%rcx
 262:	8b 95 30 ff ff ff    	mov    -0xd0(%rbp),%edx
 268:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 26f:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 276:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 27d:	ff 
 27e:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 285:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 28c:	ff 
 28d:	48 89 c7             	mov    %rax,%rdi
 290:	e8 00 00 00 00       	callq  295 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x295>
 295:	c5 f8 28 c8          	vmovaps %xmm0,%xmm1
 299:	c5 fa 10 85 4c ff ff 	vmovss -0xb4(%rbp),%xmm0
 2a0:	ff 
 2a1:	c5 fa 5c c1          	vsubss %xmm1,%xmm0,%xmm0
 2a5:	c5 fa 5e 85 48 ff ff 	vdivss -0xb8(%rbp),%xmm0,%xmm0
 2ac:	ff 
 2ad:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 2b4:	c5 fa 11 00          	vmovss %xmm0,(%rax)

    if (t < 0.0 || t > minimum_t)
 2b8:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 2bf:	c5 fa 10 08          	vmovss (%rax),%xmm1
 2c3:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 2c7:	c5 f8 2e c1          	vucomiss %xmm1,%xmm0
 2cb:	77 15                	ja     2e2 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x2e2>
 2cd:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 2d4:	c5 fa 10 00          	vmovss (%rax),%xmm0
 2d8:	c5 f8 2e 85 fc fe ff 	vucomiss -0x104(%rbp),%xmm0
 2df:	ff 
 2e0:	76 0a                	jbe    2ec <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x2ec>
    {
      return false;
 2e2:	b8 00 00 00 00       	mov    $0x0,%eax
 2e7:	e9 9a 05 00 00       	jmpq   886 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x886>
    }

    Vector<T, 3> intersection = origin + t * direction;
 2ec:	48 8b 85 10 ff ff ff 	mov    -0xf0(%rbp),%rax
 2f3:	8b 00                	mov    (%rax),%eax
 2f5:	48 8b 8d 18 ff ff ff 	mov    -0xe8(%rbp),%rcx
 2fc:	8b 95 20 ff ff ff    	mov    -0xe0(%rbp),%edx
 302:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 309:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 310:	ff 
 311:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 318:	c5 fa 7e 95 f0 fe ff 	vmovq  -0x110(%rbp),%xmm2
 31f:	ff 
 320:	89 85 f0 fe ff ff    	mov    %eax,-0x110(%rbp)
 326:	c5 fa 10 85 f0 fe ff 	vmovss -0x110(%rbp),%xmm0
 32d:	ff 
 32e:	e8 00 00 00 00       	callq  333 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x333>
 333:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 338:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 33d:	48 89 45 a4          	mov    %rax,-0x5c(%rbp)
 341:	8b 45 ac             	mov    -0x54(%rbp),%eax
 344:	83 e0 00             	and    $0x0,%eax
 347:	09 d0                	or     %edx,%eax
 349:	89 45 ac             	mov    %eax,-0x54(%rbp)
 34c:	48 8b 4d a4          	mov    -0x5c(%rbp),%rcx
 350:	8b 55 ac             	mov    -0x54(%rbp),%edx
 353:	48 8d 85 28 ff ff ff 	lea    -0xd8(%rbp),%rax
 35a:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 361:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 368:	ff 
 369:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 370:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 377:	ff 
 378:	48 89 c7             	mov    %rax,%rdi
 37b:	e8 00 00 00 00       	callq  380 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x380>
 380:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 385:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 38a:	48 89 85 68 ff ff ff 	mov    %rax,-0x98(%rbp)
 391:	8b 85 70 ff ff ff    	mov    -0x90(%rbp),%eax
 397:	83 e0 00             	and    $0x0,%eax
 39a:	09 d0                	or     %edx,%eax
 39c:	89 85 70 ff ff ff    	mov    %eax,-0x90(%rbp)

    Vector<T, 3> u_vector = cross_product(p2 - p1, intersection - p1);
 3a2:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 3a9:	48 8b 08             	mov    (%rax),%rcx
 3ac:	8b 50 08             	mov    0x8(%rax),%edx
 3af:	48 8d 85 68 ff ff ff 	lea    -0x98(%rbp),%rax
 3b6:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 3bd:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 3c4:	ff 
 3c5:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 3cc:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 3d3:	ff 
 3d4:	48 89 c7             	mov    %rax,%rdi
 3d7:	e8 00 00 00 00       	callq  3dc <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x3dc>
 3dc:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 3e1:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 3e6:	48 89 45 b0          	mov    %rax,-0x50(%rbp)
 3ea:	8b 45 b8             	mov    -0x48(%rbp),%eax
 3ed:	83 e0 00             	and    $0x0,%eax
 3f0:	09 d0                	or     %edx,%eax
 3f2:	89 45 b8             	mov    %eax,-0x48(%rbp)
 3f5:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 3fc:	48 8d 50 0c          	lea    0xc(%rax),%rdx
 400:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 407:	48 8b 08             	mov    (%rax),%rcx
 40a:	8b 40 08             	mov    0x8(%rax),%eax
 40d:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 414:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 41b:	ff 
 41c:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 423:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 42a:	ff 
 42b:	48 89 d7             	mov    %rdx,%rdi
 42e:	e8 00 00 00 00       	callq  433 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x433>
 433:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 438:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 43d:	48 89 45 bc          	mov    %rax,-0x44(%rbp)
 441:	8b 45 c4             	mov    -0x3c(%rbp),%eax
 444:	83 e0 00             	and    $0x0,%eax
 447:	09 d0                	or     %edx,%eax
 449:	89 45 c4             	mov    %eax,-0x3c(%rbp)
 44c:	48 8b 75 b0          	mov    -0x50(%rbp),%rsi
 450:	8b 4d b8             	mov    -0x48(%rbp),%ecx
 453:	48 8b 55 bc          	mov    -0x44(%rbp),%rdx
 457:	8b 45 c4             	mov    -0x3c(%rbp),%eax
 45a:	48 89 b5 f0 fe ff ff 	mov    %rsi,-0x110(%rbp)
 461:	c5 fa 7e 95 f0 fe ff 	vmovq  -0x110(%rbp),%xmm2
 468:	ff 
 469:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 470:	c5 fa 7e 9d f0 fe ff 	vmovq  -0x110(%rbp),%xmm3
 477:	ff 
 478:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 47f:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 486:	ff 
 487:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 48e:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 495:	ff 
 496:	e8 00 00 00 00       	callq  49b <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x49b>
 49b:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 4a0:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 4a5:	48 89 85 74 ff ff ff 	mov    %rax,-0x8c(%rbp)
 4ac:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
 4b2:	83 e0 00             	and    $0x0,%eax
 4b5:	09 d0                	or     %edx,%eax
 4b7:	89 85 7c ff ff ff    	mov    %eax,-0x84(%rbp)
    if (normal.scalar_product(u_vector) < 0.0)
 4bd:	48 8b 8d 74 ff ff ff 	mov    -0x8c(%rbp),%rcx
 4c4:	8b 95 7c ff ff ff    	mov    -0x84(%rbp),%edx
 4ca:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 4d1:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 4d8:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 4df:	ff 
 4e0:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 4e7:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 4ee:	ff 
 4ef:	48 89 c7             	mov    %rax,%rdi
 4f2:	e8 00 00 00 00       	callq  4f7 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x4f7>
 4f7:	c5 f8 28 c8          	vmovaps %xmm0,%xmm1
 4fb:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 4ff:	c5 f8 2e c1          	vucomiss %xmm1,%xmm0
 503:	0f 97 c0             	seta   %al
 506:	84 c0                	test   %al,%al
 508:	74 0a                	je     514 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x514>
    {
      return false;
 50a:	b8 00 00 00 00       	mov    $0x0,%eax
 50f:	e9 72 03 00 00       	jmpq   886 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x886>
    }

    u_vector = cross_product(p3 - p2, intersection - p2);
 514:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 51b:	48 8b 48 0c          	mov    0xc(%rax),%rcx
 51f:	8b 50 14             	mov    0x14(%rax),%edx
 522:	48 8d 85 68 ff ff ff 	lea    -0x98(%rbp),%rax
 529:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 530:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 537:	ff 
 538:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 53f:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 546:	ff 
 547:	48 89 c7             	mov    %rax,%rdi
 54a:	e8 00 00 00 00       	callq  54f <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x54f>
 54f:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 554:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 559:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
 55d:	8b 45 d0             	mov    -0x30(%rbp),%eax
 560:	83 e0 00             	and    $0x0,%eax
 563:	09 d0                	or     %edx,%eax
 565:	89 45 d0             	mov    %eax,-0x30(%rbp)
 568:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 56f:	48 8d 50 18          	lea    0x18(%rax),%rdx
 573:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 57a:	48 8b 48 0c          	mov    0xc(%rax),%rcx
 57e:	8b 40 14             	mov    0x14(%rax),%eax
 581:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 588:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 58f:	ff 
 590:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 597:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 59e:	ff 
 59f:	48 89 d7             	mov    %rdx,%rdi
 5a2:	e8 00 00 00 00       	callq  5a7 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x5a7>
 5a7:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 5ac:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 5b1:	48 89 45 d4          	mov    %rax,-0x2c(%rbp)
 5b5:	8b 45 dc             	mov    -0x24(%rbp),%eax
 5b8:	83 e0 00             	and    $0x0,%eax
 5bb:	09 d0                	or     %edx,%eax
 5bd:	89 45 dc             	mov    %eax,-0x24(%rbp)
 5c0:	48 8b 75 c8          	mov    -0x38(%rbp),%rsi
 5c4:	8b 4d d0             	mov    -0x30(%rbp),%ecx
 5c7:	48 8b 55 d4          	mov    -0x2c(%rbp),%rdx
 5cb:	8b 45 dc             	mov    -0x24(%rbp),%eax
 5ce:	48 89 b5 f0 fe ff ff 	mov    %rsi,-0x110(%rbp)
 5d5:	c5 fa 7e 95 f0 fe ff 	vmovq  -0x110(%rbp),%xmm2
 5dc:	ff 
 5dd:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 5e4:	c5 fa 7e 9d f0 fe ff 	vmovq  -0x110(%rbp),%xmm3
 5eb:	ff 
 5ec:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 5f3:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 5fa:	ff 
 5fb:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 602:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 609:	ff 
 60a:	e8 00 00 00 00       	callq  60f <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x60f>
 60f:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 614:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 619:	48 89 85 74 ff ff ff 	mov    %rax,-0x8c(%rbp)
 620:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
 626:	83 e0 00             	and    $0x0,%eax
 629:	09 d0                	or     %edx,%eax
 62b:	89 85 7c ff ff ff    	mov    %eax,-0x84(%rbp)
    if (normal.scalar_product(u_vector) < 0.0)
 631:	48 8b 8d 74 ff ff ff 	mov    -0x8c(%rbp),%rcx
 638:	8b 95 7c ff ff ff    	mov    -0x84(%rbp),%edx
 63e:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 645:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 64c:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 653:	ff 
 654:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 65b:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 662:	ff 
 663:	48 89 c7             	mov    %rax,%rdi
 666:	e8 00 00 00 00       	callq  66b <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x66b>
 66b:	c5 f8 28 c8          	vmovaps %xmm0,%xmm1
 66f:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 673:	c5 f8 2e c1          	vucomiss %xmm1,%xmm0
 677:	0f 97 c0             	seta   %al
 67a:	84 c0                	test   %al,%al
 67c:	74 0a                	je     688 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x688>
    {
      return false;
 67e:	b8 00 00 00 00       	mov    $0x0,%eax
 683:	e9 fe 01 00 00       	jmpq   886 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x886>
    }

    Vector<T, 3> v_vector = cross_product(p1 - p3, intersection - p3);
 688:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 68f:	48 8b 48 18          	mov    0x18(%rax),%rcx
 693:	8b 50 20             	mov    0x20(%rax),%edx
 696:	48 8d 85 68 ff ff ff 	lea    -0x98(%rbp),%rax
 69d:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 6a4:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 6ab:	ff 
 6ac:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 6b3:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 6ba:	ff 
 6bb:	48 89 c7             	mov    %rax,%rdi
 6be:	e8 00 00 00 00       	callq  6c3 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x6c3>
 6c3:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 6c8:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 6cd:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
 6d1:	8b 45 e8             	mov    -0x18(%rbp),%eax
 6d4:	83 e0 00             	and    $0x0,%eax
 6d7:	09 d0                	or     %edx,%eax
 6d9:	89 45 e8             	mov    %eax,-0x18(%rbp)
 6dc:	48 8b 95 38 ff ff ff 	mov    -0xc8(%rbp),%rdx
 6e3:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
 6ea:	48 8b 48 18          	mov    0x18(%rax),%rcx
 6ee:	8b 40 20             	mov    0x20(%rax),%eax
 6f1:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 6f8:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 6ff:	ff 
 700:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 707:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 70e:	ff 
 70f:	48 89 d7             	mov    %rdx,%rdi
 712:	e8 00 00 00 00       	callq  717 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x717>
 717:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 71c:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 721:	48 89 45 ec          	mov    %rax,-0x14(%rbp)
 725:	8b 45 f4             	mov    -0xc(%rbp),%eax
 728:	83 e0 00             	and    $0x0,%eax
 72b:	09 d0                	or     %edx,%eax
 72d:	89 45 f4             	mov    %eax,-0xc(%rbp)
 730:	48 8b 75 e0          	mov    -0x20(%rbp),%rsi
 734:	8b 4d e8             	mov    -0x18(%rbp),%ecx
 737:	48 8b 55 ec          	mov    -0x14(%rbp),%rdx
 73b:	8b 45 f4             	mov    -0xc(%rbp),%eax
 73e:	48 89 b5 f0 fe ff ff 	mov    %rsi,-0x110(%rbp)
 745:	c5 fa 7e 95 f0 fe ff 	vmovq  -0x110(%rbp),%xmm2
 74c:	ff 
 74d:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 754:	c5 fa 7e 9d f0 fe ff 	vmovq  -0x110(%rbp),%xmm3
 75b:	ff 
 75c:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 763:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 76a:	ff 
 76b:	48 89 85 f0 fe ff ff 	mov    %rax,-0x110(%rbp)
 772:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 779:	ff 
 77a:	e8 00 00 00 00       	callq  77f <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x77f>
 77f:	c4 e1 f9 7e c0       	vmovq  %xmm0,%rax
 784:	c4 e1 f9 7e ca       	vmovq  %xmm1,%rdx
 789:	48 89 45 80          	mov    %rax,-0x80(%rbp)
 78d:	8b 45 88             	mov    -0x78(%rbp),%eax
 790:	83 e0 00             	and    $0x0,%eax
 793:	09 d0                	or     %edx,%eax
 795:	89 45 88             	mov    %eax,-0x78(%rbp)

    if (normal.scalar_product(v_vector) < 0.0)
 798:	48 8b 4d 80          	mov    -0x80(%rbp),%rcx
 79c:	8b 55 88             	mov    -0x78(%rbp),%edx
 79f:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 7a6:	48 89 8d f0 fe ff ff 	mov    %rcx,-0x110(%rbp)
 7ad:	c5 fa 7e 85 f0 fe ff 	vmovq  -0x110(%rbp),%xmm0
 7b4:	ff 
 7b5:	48 89 95 f0 fe ff ff 	mov    %rdx,-0x110(%rbp)
 7bc:	c5 fa 7e 8d f0 fe ff 	vmovq  -0x110(%rbp),%xmm1
 7c3:	ff 
 7c4:	48 89 c7             	mov    %rax,%rdi
 7c7:	e8 00 00 00 00       	callq  7cc <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x7cc>
 7cc:	c5 f8 28 c8          	vmovaps %xmm0,%xmm1
 7d0:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
 7d4:	c5 f8 2e c1          	vucomiss %xmm1,%xmm0
 7d8:	0f 97 c0             	seta   %al
 7db:	84 c0                	test   %al,%al
 7dd:	74 0a                	je     7e9 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x7e9>
    {
      return false;
 7df:	b8 00 00 00 00       	mov    $0x0,%eax
 7e4:	e9 9d 00 00 00       	jmpq   886 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x886>
    }

    T uSquareOfLength = u_vector.square_of_length();
 7e9:	48 8d 85 74 ff ff ff 	lea    -0x8c(%rbp),%rax
 7f0:	48 89 c7             	mov    %rax,%rdi
 7f3:	e8 00 00 00 00       	callq  7f8 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x7f8>
 7f8:	c5 f9 7e c0          	vmovd  %xmm0,%eax
 7fc:	89 85 50 ff ff ff    	mov    %eax,-0xb0(%rbp)

    T vSquareOfLength = v_vector.square_of_length();
 802:	48 8d 45 80          	lea    -0x80(%rbp),%rax
 806:	48 89 c7             	mov    %rax,%rdi
 809:	e8 00 00 00 00       	callq  80e <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x80e>
 80e:	c5 f9 7e c0          	vmovd  %xmm0,%eax
 812:	89 85 54 ff ff ff    	mov    %eax,-0xac(%rbp)
    T areaSquareSum = normal.square_of_length();
 818:	48 8d 85 5c ff ff ff 	lea    -0xa4(%rbp),%rax
 81f:	48 89 c7             	mov    %rax,%rdi
 822:	e8 00 00 00 00       	callq  827 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x827>
 827:	c5 f9 7e c0          	vmovd  %xmm0,%eax
 82b:	89 85 58 ff ff ff    	mov    %eax,-0xa8(%rbp)

    u = sqrt(uSquareOfLength / areaSquareSum);
 831:	c5 fa 10 85 50 ff ff 	vmovss -0xb0(%rbp),%xmm0
 838:	ff 
 839:	c5 fa 5e 85 58 ff ff 	vdivss -0xa8(%rbp),%xmm0,%xmm0
 840:	ff 
 841:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
 845:	e8 00 00 00 00       	callq  84a <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x84a>
 84a:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 84e:	48 8b 85 08 ff ff ff 	mov    -0xf8(%rbp),%rax
 855:	c5 fa 11 00          	vmovss %xmm0,(%rax)
    v = sqrt(vSquareOfLength / areaSquareSum);
 859:	c5 fa 10 85 54 ff ff 	vmovss -0xac(%rbp),%xmm0
 860:	ff 
 861:	c5 fa 5e 85 58 ff ff 	vdivss -0xa8(%rbp),%xmm0,%xmm0
 868:	ff 
 869:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
 86d:	e8 00 00 00 00       	callq  872 <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x872>
 872:	c5 fb 5a c0          	vcvtsd2ss %xmm0,%xmm0,%xmm0
 876:	48 8b 85 00 ff ff ff 	mov    -0x100(%rbp),%rax
 87d:	c5 fa 11 00          	vmovss %xmm0,(%rax)

    return true;
 881:	b8 01 00 00 00       	mov    $0x1,%eax
  }
 886:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
 88a:	64 48 33 34 25 28 00 	xor    %fs:0x28,%rsi
 891:	00 00 
 893:	74 05                	je     89a <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x89a>
 895:	e8 00 00 00 00       	callq  89a <_ZN8TriangleIfE10intersectsE6VectorIfLm3EES2_RfS3_S3_f+0x89a>
 89a:	c9                   	leaveq 
 89b:	c3                   	retq   
